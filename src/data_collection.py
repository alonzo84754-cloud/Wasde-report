...
# Names must match event_mappings.csv instrument column (lowercase + underscore for file)
INSTRUMENTS = {
    # WASDE Commodities
    'Cotton': 'CT=F',
    'Coffee': 'KC=F',
    ...
    'Feeder_Cattle': 'GF=F',
    'Lean_Hogs': 'HE=F',
    # Economic Calendar Instruments (names match event_mappings.csv)
    'ES': 'ES=F',           # S&P 500 Futures
    'ZN': 'ZN=F',           # 10Y Treasury Bond Futures
    'Crude Oil': 'CL=F',    # Crude Oil
    'Natural Gas': 'NG=F',  # Natural Gas
    'Gasoline': 'RB=F',     # Gasoline (RBOB)
